...
public class ItemControllerTest {
    ...
    void deleteItem_thenRequest_whenResponseOk() throws Exception {
        ...
        verify(mockItemService).deleteItem(anyLong());
    }

    @Test
    void searchItemByText_thenRequest_whenResponseOk() throws Exception {
        String searchRequest = "searchRequest";
        when(mockItemService.searchItemByText(eq(searchRequest), eq(ownerId), eq(from), eq(size))).thenReturn(List.of(itemDtoResponse));
        ...
        verify(mockItemService).searchItemByText(eq(searchRequest), eq(ownerId), eq(from), eq(size));
    }
    ...
    void createComment_thenRequest_whenResponseOk() throws Exception {
        ...
        verify(mockItemService, times(1)).createComment(anyLong(), anyLong(), eq(commentDto));
    }
